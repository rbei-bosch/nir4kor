# Learn more about how to write integration tests for vehicle apps at:
# https://github.com/SoftwareDefinedVehicle/velocitas-docs/blob/main/docs/integration_tests.md
